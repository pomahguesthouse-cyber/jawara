...
// /dashboard/* is the UMKM member workspace. Admin access lives in a
// completely separate /admin route tree (see src/routes/admin.tsx) and
// is intentionally not exposed from here.
